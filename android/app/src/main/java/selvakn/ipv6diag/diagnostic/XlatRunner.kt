...
suspend fun runXlatDiagnostics(
    ...
    val clatQuality = if (clatPresent) {
        ...
        selvakn.ipv6diag.data.model.ClatQualityResult(
    ...
    val platVerif = if (clatPresent) {
        ...
        selvakn.ipv6diag.data.model.PlatVerificationResult(
...
private fun computeOverallStatus(
    clatPresent: Boolean,
    serverObs: selvakn.ipv6diag.data.model.ServerObservationResult,
    nat64: selvakn.ipv6diag.data.model.NAT64PrefixResult,
    dns64: selvakn.ipv6diag.data.model.DNS64ValidationResult,
    clat: selvakn.ipv6diag.data.model.ClatQualityResult,
    plat: selvakn.ipv6diag.data.model.PlatVerificationResult,
): XlatChainStatus {
